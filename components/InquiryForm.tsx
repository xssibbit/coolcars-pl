...
export function InquiryForm({ vehicleId, defaultName='', defaultEmail='', locale='pl' }: { vehicleId:string; defaultName?:string; defaultEmail?:string; locale?:Locale }) {
  ...
  return <form onSubmit={submit}>
    ...
    <div className="field"><label>{en?'Message':'Wiadomość'}</label><textarea ref={messageRef} required className="textarea" name="message" defaultValue={en?'Please contact me about this vehicle.':'Proszę o kontakt w sprawie tego pojazdu.'}/></div>
